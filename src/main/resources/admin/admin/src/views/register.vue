<template>
  <div>
      ...
      <el-form-item label="身份证号" class="input" v-if="tableName=='yonghu'">
        <el-input v-model="ruleForm.idNumber" autocomplete="off" placeholder="身份证号"  />
      </el-form-item>
      <el-form-item label="驾驶车型" class="input" v-if="tableName=='yonghu'">
        <el-input v-model="ruleForm.model" autocomplete="off" placeholder="驾驶车型"  />
      </el-form-item>
      <el-form-item label="车牌号" class="input" v-if="tableName=='yonghu'">
        <el-input v-model="ruleForm.carNumber" autocomplete="off" placeholder="车牌号"  />
      </el-form-item>
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      ...
      if((!this.ruleForm.carNumber) && `yonghu` == this.tableName){
