...
public class YonghuController {
    ...
    public R register(@RequestBody YonghuEntity yonghu){
    	...
    	YonghuEntity user = yonghuService.selectOne(new EntityWrapper<YonghuEntity>().eq("name", yonghu.getName()));
		if(user!=null) {
...
//    }
    ...
    public R save(@RequestBody YonghuEntity yonghu, HttpServletRequest request){
    	...
    	//ValidatorUtils.validateEntity(yonghu);
    	YonghuEntity user = yonghuService.selectOne(new EntityWrapper<YonghuEntity>().eq("yonghuming", yonghu.getName()));
		if(user!=null) {
